...
import com.gautam.medicinetime.task_database.TaskContract;
import com.gautam.medicinetime.task_database.TaskDatabaseHelper;
...
public class MainActivity extends AppCompatActivity {
                        ...
                        .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if(task.isEmpty()) {
                                    ...
                                    Toast.makeText(MainActivity.this, "Task can't exceed 100 characters.", Toast.LENGTH_SHORT).show();
                                }
                                    ...
                                    db.close();
                                    Toast.makeText(MainActivity.this, "Task is added successfully!", Toast.LENGTH_SHORT).show();
                                    updateUI();
                                }
                            }
                        })
    ...
    public void deleteTask(View view) {
        AlertDialog dialog = new AlertDialog.Builder(this)
                .setTitle("delete a task").setMessage("Are you sure?")
        ...
        taskTextView.setPaintFlags(257);}
        String task = String.valueOf(taskTextView.getText());
        SQLiteDatabase db = taskHelper.getWritableDatabase();
        db.delete(TaskContract.TaskEntry.TABLE, TaskContract.TaskEntry.COL_TASK_TITLE + " = ?", new String[]{task});
        db.close();
        Toast.makeText(MainActivity.this, "Task is deleted successfully!", Toast.LENGTH_SHORT).show();
        updateUI(); }  })
        .setNegativeButton("Cancel", null).create();
                    dialog.show();
    }
    ...
    public void changeColor(View view){
        View parent = (View) view.getParent();
        TextView text = (TextView) parent.findViewById(R.id.title_task);
